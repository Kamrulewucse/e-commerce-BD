                                   ...
                                   <div class="table-content table-responsive mb--30">
                                       <table class="table order-table order-table-2">
                                           ...
                                           <tr class="shipping">
                                               <th>Shipping</th>
                                               <td class="text-end">
                                                   <span>{{ format_price($shippingCost) }}</span>
                                               </td>
                                           </tr>
                                           <tr class="order-total">
                                               <th>Order Total</th>
                                               <td class="text-end"><span class="order-total-ammount">{{ format_price($subTotal+$shippingCost) }}</span>
                                               </td>
                                           </tr>
                                           </tfoot>
                                       </table>
                    ...
                    $.ajax({
                        ...
                        $.each(data, function( index, item ) {
                            if (selectedArea == item.id)
                                $('#area').append('<option value="'+item.id+'" selected>'+item.bn_name+'</option>');
                            else
                                $('#area').append('<option value="'+item.id+'">'+item.bn_name+'</option>');
                        });
