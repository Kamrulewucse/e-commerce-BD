...
<body
    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; color: #718096; height: 100%; line-height: 1.4; margin: 0; padding: 0; width: 100% !important;">
            ...
            <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tr>
                    <td class="body" width="100%" cellpadding="0" cellspacing="0"
                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%; background-color: #fff; border-bottom: 1px solid #edf2f7; border-top: 1px solid #edf2f7; margin: 0; padding: 0; width: 100%;">
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <h2 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 20px; font-weight: bold; margin-top: 0; text-align: left;">
                                        Subject: {{ $subject }}</h2>
                                    <p style="font-weight:400;box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;color: #000">
                                        Appointment Day: {{ date('(d F l)-Y',strtotime($appointmentForm->appointment_day)) }}<br>
                                        Appointment Time: {{ $appointmentForm->appointment_time }}<br>
                                        Name: {{ $appointmentForm->first_name }} {{ $appointmentForm->last_name  }}<br>
                                        Street Address : {{ $appointmentForm->street_address }}<br>
                                        Street Address Line 2 : {{ $appointmentForm->street_address_2 }}<br>
                                        City: {{ $appointmentForm->city }}<br>
                                        Region: {{ $appointmentForm->region }}<br>
                                        Post/Zip Code: {{ $appointmentForm->post_or_zip_code }}<br>
                                        Country: {{ $appointmentForm->country }}<br>
                                        Date Of Birth: {{ date('d-m-Y',strtotime($appointmentForm->date_of_birth)) }}
                                        <br>
