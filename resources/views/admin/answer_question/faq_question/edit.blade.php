...
@section('title','Edit FAQ Question & Answer')
@section('content')
    <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('faq_question.edit',['questionAnswer'=>$questionAnswer->id]) }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
