    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('magazine.add') }}" enctype="multipart/form-data" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('home_featured') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="icheck-primary d-inline">
                                    <input type="checkbox" value="1" name="home_featured" {{ old('home_featured') == '1' ? 'checked' : '' }} id="home_featured">
                        ...
                        <div class="form-group row {{ $errors->has('category_featured') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="icheck-primary d-inline">
                                    <input type="checkbox" value="1" name="category_featured" {{ old('category_featured') == '1' ? 'checked' : '' }} id="category_featured">
