    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('color.add') }}" enctype="multipart/form-data" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row {{ $errors->has('color_type') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <select name="color_type" id="color_type" class="form-control">
                                    ...
                                    <option value="1" {{ old('color_type') == 1 ? 'selected' : '' }}>Single</option>
                                    <option value="2" {{ old('color_type') == 2 ? 'selected' : '' }}>Double</option>
                                </select>
                                @error('color_type')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row {{ $errors->has('color_code') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group my-colorpicker2">
                                    ...
                                    <input type="text" autocomplete="off" value="{{ old('color_code') }}" name="color_code" class="form-control my-colorpicker2" id="color_code">
                        ...
                        <div style="display: none" id="color_code_area_2" class="form-group row {{ $errors->has('color_code_2') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group my-colorpicker3">
                                    <input type="text" autocomplete="off" value="{{ old('color_code_2') }}" name="color_code_2" class="form-control my-colorpicker3" id="color_code_2">
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-square"></i></span>
                                    </div>
                                </div>
