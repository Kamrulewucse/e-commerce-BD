            ...
            <div class="row">
                <div class="col-md-6 offset-md-1">
                    <div class="register-area">
                        ...
                        <h1 class="other-box-title">LOGIN INFORMATION(1/3)</h1>
                        <form method="post" action="{{ route('register_email_confirmation') }}">
                            @csrf
                            <div class="other-page-box">
                                <div class="row">
                                    <label class="col-12 register-label" for="email">EMAIL <span class="text-danger">*</span>
                                    ...
                                    <label class="col-12 register-label" for="email_confirmation">EMAIL CONFIRMATION <span
                                            class="text-danger">*</span>
                                        <span class="form-group">
                                        <input type="text" value="{{ old('email_confirmation') }}" name="email_confirmation" id="email_confirmation"  class="form-control register-input"
                                               placeholder="name@example.com">
                ...
                <div class="col-md-4  offset-md-1">
                    <div class="other-page-box" style="min-height: 540px">
                        ...
                        <div class="login-step-detail">
                            <h1 class="other-box-title">WHAT YOU'LL FIND IN YOUR BD ACCOUNT</h1>
