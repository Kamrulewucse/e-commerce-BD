...
class BankController extends Controller
{
    public function index() {
        ...
        return view('admin.bank_n_account.bank.all', compact('banks'));
    }

    public function add() {
        return view('admin.bank_n_account.bank.add');
    }
    ...
    public function edit(Bank $bank) {
        return view('admin.bank_n_account.bank.edit', compact('bank'));
    }
