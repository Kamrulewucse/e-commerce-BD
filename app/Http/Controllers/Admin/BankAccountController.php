...
class BankAccountController extends Controller
{
    public function index() {
        ...
        return view('admin.bank_n_account.account.all', compact('accounts'));
    }

    public function add() {
        $banks = Bank::orderBy('name')->get();

        return view('admin.bank_n_account.account.add', compact('banks'));
    }
    ...
    public function edit(BankAccount $account) {
        ...
        return view('admin.bank_n_account.account.edit', compact('banks', 'account'));
    }
