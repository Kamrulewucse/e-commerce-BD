...
class BranchController extends Controller
{
    public function index() {
        ...
        return view('admin.bank_n_account.branch.all', compact('branches'));
    }

    public function add() {
        $banks = Bank::orderBy('name')->get();

        return view('admin.bank_n_account.branch.add', compact('banks'));
    }
    ...
    public function edit(Branch $branch) {
        ...
        return view('admin.bank_n_account.branch.edit', compact('banks', 'branch'));
    }
